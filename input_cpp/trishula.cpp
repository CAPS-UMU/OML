...
unsigned long read_instr_direct() {
    unsigned long instr;
...
int main(int argc, char *argv[]) {
    ...
    unsigned long instr = read_instr_direct();
    OMTensorList *tensorListOut = run_main_graph(tensorListIn);
    unsigned long instr_after = read_instr_direct();
    ...
    std::cout << "Cycles: instr >>>>>>>>" << instr_after - instr << std::endl;
